...
public class AuditClient {
  ...
  public void emit(UUID passportId, UUID actorUserId, String actorRole,
                   String action, String detail) {
    try {
      Map<String, Object> body = new HashMap<>();
      body.put("service", "passport-service");
      body.put("action", action);
      body.put("occurredAt", OffsetDateTime.now().toString());
      if (passportId != null) body.put("applicationId", passportId.toString());
